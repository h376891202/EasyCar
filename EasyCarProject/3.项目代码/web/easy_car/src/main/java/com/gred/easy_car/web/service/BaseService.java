 ...
 * @Description: (此类为Service层基础接口)   
 * @author WangJianbin     
 * @date 2015年4月25日 下午2:11:08   
 * @version V2.0     
 */
...
public interface BaseService<M,PK extends Serializable> {    
     ...
     * @return 影响记录条数 
     */  
    public abstract int save(M entity);  
     ...
     */    
    public abstract int modify(M entity);    
     ...
     */    
    public abstract int modifyParam(Map param);    
     ...
     */    
    public abstract int remove(PK primaryKey);    
     ...
     * @return  
     */    
    public abstract int removeParam(Map param);    
     ...
     */    
    public abstract M get(PK primaryKey);    
     ...
     */    
    public abstract List<M> listParam(Map param);    
     ...
     * @param list  
     */    
    public abstract int batchSave(final List<M> list);    
        
    /**  
     * 批量修改  
     * @param list  
     */    
    public abstract int batchUpdate(final List<M> list);    
        
    /**  
     * 批量删除  
     * @param list  
     */    
    public abstract int batchDelete(final List<PK> list);    

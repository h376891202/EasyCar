...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    BOOL ret = [_mapManager start:@"q0RP9SRHTzIyrqvNPyIXqhGh"  generalDelegate:nil];
    if (!ret) {
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "web.______" in the application's documents directory.
